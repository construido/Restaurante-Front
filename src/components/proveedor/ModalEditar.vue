<template>
    ...
    <Dialog header="Actualizar Cliente" v-model:visible="proveedorModal" :breakpoints="{'960px': '75vw', '640px': '90vw'}" :style="{width: '50vw'}" :modal="true">
        <div class="p-fluid grid p-4">
            <div class="field col-12 md:col-6">
                <span class="p-float-label">
                    <InputText id="nombre" type="text" v-model="datosProveedor.nombre" style="text-transform: uppercase"/>
        ...
        <div class="p-fluid grid p-4">
            ...
            <div class="field col-12 md:col-6">
                <span class="p-float-label">
                    <InputText id="correo" type="text" v-model="datosProveedor.correo" style="text-transform: uppercase"/>
